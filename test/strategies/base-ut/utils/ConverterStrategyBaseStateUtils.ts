...
import {ConverterStrategyBase} from "../../../../typechain";

/**
 * All balances related to ConverterStrategyBase
 */
export interface IConverterStrategyBaseState {
  title: string;
  block: number;
 ...
 */
export class ConverterStrategyBaseStateUtils {
