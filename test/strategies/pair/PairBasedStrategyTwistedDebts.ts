        ...
        strategies.forEach(function (strategyInfo: IStrategyInfo) {
          if (chainId === strategyInfo.chainId) {
            ...
            async function prepareStrategy(): Promise<IPrepareStrategyResults> {
              ...
              await TokenUtils.getToken(b.asset, signer.address, parseUnits('2000', b.assetDecimals));
              await b.vault.connect(signer).deposit(parseUnits('100', b.assetDecimals), signer.address, {gasLimit: 19_000_000});
