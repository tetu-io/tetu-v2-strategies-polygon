...
export function extractMatchingContractInformation(
  ...
  // console.log('extractMatchingContractInformation')
...
export async function extractInferredContractInformation(
  ...
  console.log('extract Inferred Contract Information');
  const contractMatches = await lookupMatchingBytecode(
    artifacts,
    matchingCompilerVersions,
    bytecode,
  );
  console.log('contractMatches.length', contractMatches.length);
...
export async function getLibraryInformation(
  ...
  // console.log('normalizedLibraries', normalizedLibraries);
...
async function lookupMatchingBytecode(
  ...
  console.log('fqNames', fqNames.length);
  ...
  for (const fqName of fqNames) {
    ...
    if (contractInformation !== null) {
      console.log('contractInformation matched', i, fqName);
