...
subtask(TASK_VERIFY_RESOLVE_ARGUMENTS)
  ...
  .setAction(
    async({
      ...
      // console.log('Run ', TASK_VERIFY_RESOLVE_ARGUMENTS);
...
subtask(TASK_VERIFY_GET_VERIFICATION_SUBTASKS, async(): Promise<string[]> => {
  // console.log('Run ', TASK_VERIFY_GET_VERIFICATION_SUBTASKS);
...
subtask(TASK_VERIFY_ETHERSCAN)
  ...
  .setAction(
    async(
      ...
      // console.log('Run ', TASK_VERIFY_ETHERSCAN);
...
subtask(TASK_VERIFY_ETHERSCAN_GET_CONTRACT_INFORMATION)
  ...
  .setAction(
    async(
      ...
      // console.log('Run ', TASK_VERIFY_ETHERSCAN_GET_CONTRACT_INFORMATION);
      ...
      console.log('info contractInformation', contractInformation.contractName);
      console.log('info libraryInformation', libraryInformation);
...
subtask(TASK_VERIFY_ETHERSCAN_ATTEMPT_VERIFICATION)
  ...
  .setAction(
    async({
      ...
      // console.log('Run ', TASK_VERIFY_ETHERSCAN_ATTEMPT_VERIFICATION);
      ...
      console.log('compiler version', contractInformation.solcLongVersion);
      console.log('contract fq', contractInformation.sourceName);
      if (!fs.existsSync('./tmp/verify')) {
        fs.mkdirSync('./tmp/verify', { recursive: true });
      }
      fs.writeFileSync(
        `./tmp/verify/verifybc_${contractInformation.contractName}.json`,
...
subtask(TASK_VERIFY_VERIFY)
  ...
  .setAction(
    async(
      ...
      // console.log('Run ', TASK_VERIFY_VERIFY);
      if (address === undefined) {
        throw new MissingAddressError();
      }
...
subtask(
  ...
  // console.log('Run ', TASK_VERIFY_PRINT_SUPPORTED_NETWORKS);
