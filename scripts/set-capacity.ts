...
const STRATS = new Map<string, number>([
  ...
  ['0x6565e8136CD415F053C81Ff3656E72574F726a5E', 10_000], // UniV3 USDC/USDT-100 NSR
  ['0x4B8bD2623d7480850E406B9f2960305f44c7aDeb', 10_000], // Kyber USDC/USDT NSR
  ['0x8EC9134046740F83BDED78d6DDcAdAEC42fC61b0', 10_000], // Kyber USDC/DAI NSR
]);
