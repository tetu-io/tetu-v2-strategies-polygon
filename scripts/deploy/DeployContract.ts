...
const libraries = new Map<string, string[]>([
  ...
  ['UniswapV3ConverterStrategyLogicLib', ['UniswapV3Lib', 'UniswapV3DebtLib', 'ConverterStrategyBaseLib2', 'PairBasedStrategyLib', 'StrategyLib2', 'PairBasedStrategyLogicLib']],
