...
const func: DeployFunction = async function(hre: HardhatRuntimeEnvironment) {
  ...
  const { deployer, CONVERTER_ADDRESS, PANCAKE_USDC_USDT_ZKEVM, SPLITTER_USDC_ADDRESS_ZKEVM, PANCAKE_MASTERCHEF_ZKEVM } = await getNamedAccounts();
...
func.skip = async hre => true // (await hre.getChainId()) !== '1101'
